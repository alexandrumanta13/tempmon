...
<script>
    ...
    function getData() {
        $.post('http://tempmon.ro/monitor/api/assigned_sensors.php', {location_id: 14}, function(response){
            ...
            for(let i = 0; i < response.body.length; i++)
            {
                ...
                <li>
                    ...
                    <div class="sensor-list-details">
                     ...
                     <div class="raport">
                        <a class="btn primary" href="http://tempmon.ro/demo?sensorid=${sensorid}&locationid=${storeid}">Raport</a>
                    </div>
                </li>
                `
