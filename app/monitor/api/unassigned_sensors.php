...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    {
        $query = " SELECT ts.id, ts.name, ts.sensorid, ts.storeid, ts.maxtemp, ts.mintemp, tsdt.current_temp,tsdt.interval_min, tsdt.interval_max, tsdt.report_frequency, tsdt.reported_at, ts.assigned FROM temperature_sensors ts 
