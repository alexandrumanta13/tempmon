...
<head>
    ...
    <title>tempmon.ro - demo - delete location</title>
...
<div class="main-content add-user-page">
  ...
  <main class="main-container">
    ...
    <h1>Sterge locatia din baza de date</h1>
    <h1 class="warning">Esti sigur ca vrei sa stergi locatia <?= $name ?> situata pe <?= $address ?>?</h1>
