...
function getTodayData() {
    ...
    .then(data => {
        ...
        //     {
        //         data.body.map((v, index) => {
        //             hours[v.hour].current_temp = parseInt(v.current_temp);
        //             hours[v.hour].offline = 0;
        //         })
        ...
        // }
            ...
            // } else {
                ...
                // let tempArr = data.body.map((i, idx) => {
                //     return parseInt(data.body[idx].hour);
                // })
                ...
                // let finalArr = hours.map((i, idx) => {
                //     hours.hour.filter((hour) => !data.body.hour.includes(hour));
                //     return hour;
                // })
                ...
                //     hours[v.hour].current_temp = parseInt(v.current_temp); // schimbam temperatura curenta din 0 in data.current_temp in obiectul de hours, pt fiecare ora existenta in 'data'
                //     hours[v.hour].offline = 0;
                //     return hours;
                // })
                // console.log(tempArr);
                ...
                let hoursArr = hours.map((i, idx) => {
                    return hours[idx].day;
                })
                hoursArr.filter((day, idx) => {
                    if (tempArr.includes(day)) {
                        if (hours[idx].day == day) {
                            hours[idx].offline = 0;
                ...
                //         } else {
                //             hours[idx].offline = 1;
                //             hours[idx].current_temp = data.body[idx].current_temp;
                //             return hours;
                //         }
                //     }
                // });
                ...
                //console.log("hours" + hours[i].hour);
                //console.log("outside" + finalArr[i]);
                //if(hours[i].hour != finalArr[i]) {
                // console.log("sadadadsa" + hours[i].current_temp);
                // hours[i].current_temp = hours[i - 1].current_temp;
                // hours[i].offline = 0;
                //}
                // if (hours[i].offline = 1) {
                //     hours[i].current_temp = hours[i - 1].current_temp;
                //     hours[i].offline == 1 ? hours[i].offline = 1 : hours[i].offline = 0;
                // }
                //}
            ...
            let todayArr = hours.map((i, idx) => {
                console.log(hours[idx].current_temp);
